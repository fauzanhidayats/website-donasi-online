...
class PengajuanDonasiPimpinanController extends Controller
{
    public function index()
    {
        $pengajuan = PengajuanDonasi::orderBy('tanggal_pengajuan', 'desc')->get();
        return view('pimpinan.pengajuan-donasi.index', compact('pengajuan'));
    }

    public function show($id)
    {
        $pengajuan = PengajuanDonasi::findOrFail($id);
        return view('pimpinan.pengajuan-donasi.detail', compact('pengajuan'));
    }
