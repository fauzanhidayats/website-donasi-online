...
class LaporanAdminDonasiController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('admin.laporan-donasi.index', compact('events'));
    }
    ...
    public function laporanDonasi(Request $request)
    {
        ...
        return view('admin.laporan-donasi.donasi', compact('donasi', 'totalDonasi'));
    }
    ...
    public function cetakDonasiPDF(Request $request)
    {
        ...
        $pdf = PDF::loadView('admin.laporan-donasi.pdf_donasi', [
            'donasi' => $donasi,
            'event' => $event,
