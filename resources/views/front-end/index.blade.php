...
<!-- Carousel -->
<section aria-label="Main banner with call to action" class="container-fluid position-relative p-0">
    <div class="owl-carousel">
        <div><img src="{{ asset('assets/img/gambar 1.jpg') }}" alt="Gambar 1" class="w-100" /></div>
        <div><img src="{{ asset('assets/img/gambar 2.jpg') }}" alt="Gambar 2" class="w-100" /></div>
        <div><img src="{{ asset('assets/img/gambar 3.jpg') }}" alt="Gambar 3" class="w-100" /></div>
    </div>

    <!-- Statistik -->
    <div class="container bg-white rounded-3 shadow d-flex justify-content-around align-items-center py-3 px-3">
        <div class="text-center">
            <p class="text-custom-green fw-bolder fs-6 fs-sm-5 mb-1">
                Rp {{ number_format($totalDana, 0, ',', '.') }}
            </p>
            <p class="fs-7 text-secondary mb-0">Terkumpul</p>
        </div>
        <div class="text-center">
            <p class="text-custom-green fw-bolder fs-6 fs-sm-5 mb-1">{{ number_format($totalDonatur) }}</p>
            <p class="fs-7 text-secondary mb-0">Donatur</p>
        </div>
        <div class="text-center">
            <p class="text-custom-green fw-bolder fs-6 fs-sm-5 mb-1">{{ $totalEvents }}</p>
            <p class="fs-7 text-secondary mb-0">Event</p>
        </div>
    </div>
</section>
...
<section class="container px-3 px-sm-4 px-md-5 mt-5 text-center">
    <a href="{{ route('all-event.index') }}" class="btn btn-custom-green fw-semibold py-2 px-5 rounded-3">
        LIHAT PROGRAM LAINNYA
    </a>
</section>


<section aria-label="Sebarkan Kebaikan social share" class="container px-3 px-sm-4 px-md-5 mt-5 text-center">
    <h3 class="fs-6 text-secondary tracking-wider mb-4 text-uppercase">
        SEBARKAN <span class="fw-semibold text-custom-green"> KEBAIKAN </span>
    </h3>
    <div class="d-flex justify-content-center gap-3 mx-auto" style="max-width: 400px">
        <a aria-label="Share on Facebook"
            class="btn btn-primary btn-sm fw-semibold py-2 px-3 d-flex align-items-center justify-content-center"
            href="#" style="background-color: #3b5998; border-color: #3b5998">
            <i class="fab fa-facebook-f me-2"></i>
            Facebook
        </a>
        <a aria-label="Share on Twitter"
            class="btn btn-info btn-sm fw-semibold py-2 px-3 d-flex align-items-center justify-content-center"
            href="#" style="background-color: #1da1f2; border-color: #1da1f2">
            <i class="fab fa-twitter me-2"></i>
            Twitter
        </a>
        <a aria-label="Share on Whatsapp"
            class="btn btn-success btn-sm fw-semibold py-2 px-3 d-flex align-items-center justify-content-center"
            href="#" style="background-color: #25d366; border-color: #25d366">
