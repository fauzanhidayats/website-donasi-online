                        ...
                        <div class="card-body">
                            <form action="{{ route('event.update', $event->id) }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" name="target_donasi"
                                        class="form-control @error('target_donasi') is-invalid @enderror"
                                        value="{{ old('target_donasi', $event->target_donasi) }}">
                                    @error('target_donasi')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="foto_event">Foto Event</label><br>
                                    @if ($event->foto_event)
                                        <img src="{{ asset('storage/' . $event->foto_event) }}" alt="Foto Event"
