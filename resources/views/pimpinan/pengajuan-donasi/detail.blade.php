    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="{{ route('pimpinan.pengajuan.index') }}">Pengajuan Donasi</a>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @if ($pengajuan->status_pengajuan === 'diajukan')
                                <form action="{{ route('pimpinan.pengajuan.updateStatus', $pengajuan->id) }}"
                                    ...
                                    <a href="{{ route('pimpinan.pengajuan.index') }}" class="btn btn-secondary">Kembali</a>
                                </form>
                            @else
                                <div class="mt-4">
                                    <p>Status saat ini:
